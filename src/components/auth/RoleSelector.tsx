...
export default function RoleSelector() {
  ...
  const roles = [
    ...
    },
    {
      id: 'logistics',
      title: 'Logistics',
      description: 'Track shipments and manage custody transfers',
      icon: '🚚',
      color: 'bg-amber-50 text-amber-700 border-amber-200 hover:border-amber-500',
      buttonColor: 'bg-amber-600 hover:bg-amber-700',
      features: ['Scan for pickup', 'Transfer custody', 'Export docs']
    },
    {
      id: 'consumer',
      title: 'Consumer',
        ...
        {roles.map((role, index) => (
          ...
          >
            ...
            <button
              ...
              className={cn(
                "w-full py-3 px-4 rounded-lg text-white font-medium transition-all duration-200 transform group-hover:translate-y-1",
                role.buttonColor
              )}
            >
              Enter as {role.title}
